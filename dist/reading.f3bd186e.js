...
function tasklist() {
    ...
    function renderTask(task1) {
        ...
        item.innerHTML = "<p>" + task1.taskDescription + " | " + "created on: " + task1.createdDate + " | " + "due on: " + task1.dueDate + " | " + "priority rate: " + task1.priorityRating + " | " + "estimated time completed: " + task1.estimatedTime + "</p>";
        let tasklist2 = document.getElementById("tasklist");
    ...
    function updateEmpty() {
        if (taskList.length > 0) {
            ...
            document.getElementById("taskHeading").style.display = "none";
        } else {
